...
class CreatableSingleSelectDropdown extends React.Component {
  state = {
    inputValue: '',
...
CreatableSingleSelectDropdown.propTypes = {
  classes: PropTypes.object.isRequired,
  theme: PropTypes.object.isRequired,
};

export default withStyles(useStyles, {withTheme: true})(CreatableSingleSelectDropdown);
