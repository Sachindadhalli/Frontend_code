  ...
  render() {
    ...
    return (
      <div className="basic-details-main-container">
        <CollapsibleComponent collapsibleTitle="Employment">
          {fresher_experienced === false ? (
            <div>
              {employment_details.map((values) => {
                return (
                    ...
                    <div className="experiance-employment">
                      <Grid container spacing={16}>
                        ...
                        <Grid item xs={12} md={8}>
                          <IconValueComponent iconName={company}
                                              text={values.currently_working ? values.organization + ' ( Currently working here )' : values.organization}/>
                        </Grid>
                      </Grid>
                      <Grid container spacing={16}>
                        <Grid item xs={12} md={12}>
                          <LabelValueComponent label="Roles and Responsibilities" value={values.roles}/>
                        </Grid>
                      </Grid>
                      <Grid container spacing={16}>
                        <Grid item xs={12} md={4}>
            ...
            <div className="main-container-div">
              {training_internship.internship.length !== 0 ? <div className="fresher-internship">
                <div className="title-for-internship-fresher">Internship</div>
                <div className="fresher-internship-content">
                  <div>
                    {training_internship.internship.map((values) => {
                      return (
                        <div>
                          <Grid container spacing={16}>
                            <Grid item xs={12} md={8}>
              ...
              {training_internship.training.length !== 0 ? <div className="fresher-traning">
                ...
                <div className="fresher-traning-content">
                  <div>
                    {training_internship.training.map((values) => {
                      return (
                        <div>
                          <Grid container spacing={16}>
                            <Grid item xs={12} md={8}>
                    ...
                    {employment_details.map((values) => {
                      return (
                        <div className="fresher-employment">
                          <Grid container spacing={16}>
                            <Grid item xs={12} md={4}>
                              <IconValueComponent iconName={workExpIcon}
                                                  text={values.job_title ? values.job_title : "-"}/>
                            </Grid>
                            <Grid item xs={12} md={8}>
                              <IconValueComponent
                                iconName={company}
