...
class UserMyAchievementsExperienced extends React.Component {
            ...
            <div className="label-value-body">
                <CollapsibleComponent collapsibleTitle="My Achievements" >
                    <div className="align-in-collapse">
                        <div>
                            {training_internship.internship ? <div>
                        ...
                        <div>
                            {achievements.online_profile ? <div>
                                ...
                                {achievements.patent.map((values, index) => {
                                    return <div className="box-details" key={index}>
                                        ...
                                        <div>
                                            <Grid container spacing={16} >
                                                <Grid item xs={12} md={4}>
                                                    <LabelValueComponent label={"Status"} value={values.issued ? "Patent Issued" : "Patent Pending"} />
                                                </Grid>
                                                <Grid item xs={12} md={4}>
                        ...
                        <div>
                            {achievements.certification ? <div>
...
UserMyAchievementsExperienced.propTypes = {
    classes: PropTypes.object.isRequired
};

export default withStyles(styles)(UserMyAchievementsExperienced);
