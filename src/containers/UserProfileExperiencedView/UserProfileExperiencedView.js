...
// import UserEmploymentExperienced from '../UserProfileFreshers/components/UserEmployment/UserEmploymentExperienced';
import UserSideBarView from '../UserProfileFresherView/components/UserSideBarView/UserSideBarView';
...
import UserKeySkillsView from '../UserProfileFresherView/components/UserKeySkillsView/UserKeySkillsView';
//import UserTechnologiesView from '../UserProfileFresherView/components/UserKeySkillsView/UserTechnologiesView
...
import Technologies from '../../containers/EmployerInbox/component/AppliedUserProfile/Components/Technologies/Technologies';
...
import ExperiencedEmpView from './ExperiencedEmpView/ExperiencedEmpView';
import ExperiencedBasicDetails from '../UserProfileExperienced/components/ExperiencedBasicDetails/ExperiencedBasicDetails';
        ...
        <EmployerSideNav>
          ...
          <div className="inbox-user-profile-auto-overflow">
            <div className="inbox-user-profile-border-padding">
              {currently_opened_tab == 5 ? (
                <div>
                  <CustomBreadcrumb breadcrumb_text="Edit Profile" />
                </div>
              ) : (
                <div>
              ...
              <div className="inbox-user-profile-right-container">
                <div className="inbox-user-profile-left-wraper">
                  ...
                  /> */}
                  <div className="component-div-padding">
                    <UserKeySkills isItEditMode={false} />
                  </div>
                  {/* <div className="component-div-padding">
                    <UserEmploymentView
