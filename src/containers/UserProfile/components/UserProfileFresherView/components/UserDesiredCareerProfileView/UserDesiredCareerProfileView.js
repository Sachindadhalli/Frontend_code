...
import UserBasicDetailsView from '../UserBasicDetailsView/UserBasicDetailsView';
...
class UserDesiredCareerProfileView extends Component {
    render() {
        return (
...
export default UserDesiredCareerProfileView;
