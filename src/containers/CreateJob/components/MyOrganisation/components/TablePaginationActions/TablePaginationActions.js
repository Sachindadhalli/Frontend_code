...
class TablePaginationActions extends React.Component {
  ...
  /**
   * To handle click on first page icon
   * @param: event
  ...
  /**
   * To handle click on back page icon
   * @param: event
   * @return:  call back a function
   * */
  ...
  /**
   * To handle click on next page icon
   * @param: event
   * @return:  call back a function
   * */
  ...
  /**
   * To handle click on last page icon
   * @param: event
   * @return:  call back a function
   * */
  ...
  /**
   * To validate the on click of icons
   * @param: event
   * @return:  call back a function
   * */
  onPageChange = (e) => {
