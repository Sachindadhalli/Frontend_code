...
import clock from '../../../../../assets/media/icons/clock.svg';
import Moment from 'react-moment';
import ExperiencedBasicDetailsEdit from '../ExperiencedBasicDetails/components/ExperiencedBasicDetailsEdit';
import ExperiencedBasicDetailsView from '../ExperiencedBasicDetails/components/ExperiencedBasicDetailsView';
//import ExperiencedBasicDetailsView from './components/ExperiencedBasicDetailsView';
...
class ExperiencedBasicDetails extends Component {
  state = {
    editMode: false,
  };
...
export default withStyles(styles)(ExperiencedBasicDetails);
